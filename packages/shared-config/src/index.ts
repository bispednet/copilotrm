...
export function loadConfig(
  ...
  return {
    ...
    llm: {
      ...
      tegemStreamPollIntervalMs: readNumber(env, 180, 'STREAM_POLL_INTERVAL_MS', 'TEGEM_STREAM_POLL_INTERVAL_MS'),
      tegemStreamStableTicks: readNumber(env, 3, 'STREAM_STABLE_TICKS', 'TEGEM_STREAM_STABLE_TICKS'),
      tegemStreamFirstChunkTimeoutMs: readNumber(env, 12_000, 'STREAM_FIRST_CHUNK_TIMEOUT_MS', 'TEGEM_STREAM_FIRST_CHUNK_TIMEOUT_MS'),
      tegemStreamMaxDurationMs: readNumber(env, 75_000, 'STREAM_MAX_DURATION_MS', 'TEGEM_STREAM_MAX_DURATION_MS'),
